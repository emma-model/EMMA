...
par=i_exo_export         rng=export!a6:z8768             rdim=1 cdim=3
$offecho

$CALL GDXXRW.exe        input\exoexport.xlsx    Squeeze=N     @exoexport.txt

$onecho > exoload.txt
par=i_exo_load           rng=load!a6:z8768             rdim=1 cdim=3
par=i_exo_h2_demand      rng=hydrogen!a2:z5         rdim=0 cdim=3
$offecho

$CALL GDXXRW.exe        input\exoload.xlsx      Squeeze=N     @exoload.txt
